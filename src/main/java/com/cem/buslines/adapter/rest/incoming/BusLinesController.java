...
public class BusLinesController {
  ...
  @GetMapping("/bus-lines/top")
  public Flux<BusLineResponse> getTopBusLines(@RequestParam Integer numberOfResults) {
    log.debug("Received getTopBusLines request: {}", numberOfResults);
